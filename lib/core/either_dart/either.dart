...
sealed class Either<L, R> {
  ...
  static Either<L, R> cond<L, R>(L leftValue, R rightValue, {bool test = false}) =>
      test ? Right(rightValue) : Left(leftValue);

  /// If the condition is true then return [rightValue] in [Right] else [leftValue] in [Left]
  static Either<L, R> condLazy<L, R>(
           Lazy<L> leftValue, Lazy<R> rightValue, {bool test = false}) =>
      test ? Right(rightValue()) : Left(leftValue());
...
class Left<L, R> extends Either<L, R> {
  ...
  @override
  Either<TL, TR> either<TL, TR>(
      TL Function(L left) fnL, TR Function(R right) fnR) => Left<TL, TR>(fnL(value));
  ...
  @override
  Future<Either<L, TR>> thenAsync<TR>(
      FutureOr<Either<L, TR>> Function(R right) fnR) => Future.value(Left<L, TR>(value));
  ...
  @override
  Future<Either<TL, R>> thenLeftAsync<TL>(
      FutureOr<Either<TL, R>> Function(L left) fnL) => Future.value(fnL(value));
...
class Right<L, R> extends Either<L, R> {
  ...
  @override
  Either<TL, TR> either<TL, TR>(
      TL Function(L left) fnL, TR Function(R right) fnR) => Right<TL, TR>(fnR(value));
  ...
  @override
  Future<Either<L, TR>> thenAsync<TR>(
      FutureOr<Either<L, TR>> Function(R right) fnR) => Future.value(fnR(value));
  ...
  @override
  Future<Either<TL, R>> thenLeftAsync<TL>(
      FutureOr<Either<TL, R>> Function(L left) fnL) => Future.value(Right<TL, R>(value));
